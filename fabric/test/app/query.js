...
var queryChaincode = function (peer, channelName, chaincodeName, chaincodeVersion, fn, args, username, org) {
  var peers = []
  ...
  logger.info('querying ', peer, chaincodeName, chaincodeVersion, fn, args)
